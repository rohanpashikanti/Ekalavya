  ...
  const generateQuestions = async () => {
    ...
    try {
      ...
      if (topic === 'Verbal Reasoning') {
        prompt = `Generate 20 multiple choice questions about Verbal Reasoning covering Blood Relations, Seating Arrangements, and Directions. 
        ...
        prompt = `Generate 20 multiple choice questions about Analogical Reasoning covering Analogies, Series Completion, and Syllogisms.
        Each question should have 4 options and one correct answer.
        Format each question as a JSON object with:
        {
          "question": "question text",
